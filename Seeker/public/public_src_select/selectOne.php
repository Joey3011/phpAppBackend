...
if(isset($_POST['input'])) {
    $input = $_POST['input'];
$output = '';
$query = "SELECT * FROM ts_sub_one WHERE sub_id LIKE '%{$input}%'";
...
<th style="font-size: 11px; color: #000; width: 10.55%;"><p>St six</p></th>
<th style="font-size: 11px; color: #000; width: 10.55%;"><p>St seven</p></th>
...
if(mysqli_num_rows($result) > 0){
    ...
    <td style="font-size: 9px; color: #000;"><button class="btn btn-danger btn-sm del_one" data-id="'. $issue['id'] .'" id="del_one" style="width:100%; font-size: 9px;">Delete</button>
