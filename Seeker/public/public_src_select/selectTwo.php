...
if(isset($_POST['input'])) {
    $input = $_POST['input'];
$output = '';
$query = "SELECT * FROM ts_sub_two WHERE sub_id LIKE '%{$input}%'";
...
if(mysqli_num_rows($result) > 0){
    ...
    <td style="font-size: 11px; color: #000;"><button class="btn btn-danger btn-sm del_two" data-id="'. $issue['id'] .'" id="del_two" style="width:100%; font-size: 9px;">Delete</button>
